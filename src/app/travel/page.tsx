  ...
  const travelContent = [
    {
      ...
      url: 'https://www.instagram.com/reel/DVqMLZHkZLH/',
      caption: 'Travel adventures and lifestyle moments from around the world',
      postId: 'DVqMLZHkZLH',
    },
    {
      id: '2',
      type: 'instagram' as const,
      url: 'https://www.instagram.com/p/DUriVFWjSDH/',
      caption: 'Discovering beauty and culture across continents',
      postId: 'DUriVFWjSDH',
    },
    {
      id: '3',
      type: 'instagram' as const,
      url: 'https://www.instagram.com/reel/DCvFZHshJ8w/',
      caption: 'Behind-the-scenes travel experiences and insights',
      postId: 'DCvFZHshJ8w',
    },
    {
      id: '4',
      type: 'instagram' as const,
      url: 'https://www.instagram.com/p/CzXyd2rhQi-/',
      caption: 'Multi-destination journey: exploring markets and cultures',
      postId: 'CzXyd2rhQi-',
    },
    {
      id: '5',
      type: 'instagram' as const,
      url: 'https://www.instagram.com/p/DLHcNE6Sgh3/',
      caption: 'Global connections through travel and authentic experiences',
      postId: 'DLHcNE6Sgh3',
    },
    {
      id: '6',
      type: 'tiktok' as const,
      url: 'https://vt.tiktok.com/ZSChhEw8j/',
      caption: 'Travel vlog: exploring new destinations',
    },
    {
      id: '7',
      type: 'tiktok' as const,
      url: 'https://vt.tiktok.com/ZSChk1RgF/',
      caption: 'Cultural experiences and local markets',
    },
    {
      id: '8',
      type: 'tiktok' as const,
      url: 'https://vt.tiktok.com/ZSChhpCWL/',
      caption: 'Trade connections: from China to PNG',
    },
    {
      id: '9',
      type: 'tiktok' as const,
      url: 'https://vt.tiktok.com/ZSChkUaFd/',
      caption: 'Business travel insights and logistics',
    },
    {
      id: '10',
      type: 'tiktok' as const,
      url: 'https://vt.tiktok.com/ZSChkLkLj/',
      caption: 'Lifestyle moments from around the world',
    },
    {
      id: '11',
      type: 'tiktok' as const,
      url: 'https://vt.tiktok.com/ZSChkbYyM/',
      caption: 'Adventures in international business and culture',
    },
  ]
  ...
  const destinations = [
    {
      city: 'Paris',
      country: 'France',
      image: '/content/travel/paris-eiffel-tower.jpg',
      description: 'The city of light and luxury — where art, fashion, and beauty converge in timeless elegance.',
      highlights: 'Beauty & Design Inspiration',
    },
    {
      city: 'Nairobi',
      country: 'Kenya',
      image: '/content/travel/giraffe-centre-kenya.jpg',
      description: 'Wildlife, warmth, and vibrant culture. East Africa\'s beating heart and a gateway to extraordinary experiences.',
      highlights: 'Culture & Wildlife',
    },
    {
      city: 'Norway',
      country: 'Scandinavia',
      image: '/content/travel/norway-winter.jpg',
      description: 'Snow-capped fjords and arctic serenity. Finding stillness and perspective in the far north.',
      highlights: 'Nature & Reflection',
    },
    {
      city: 'Guangzhou',
      country: 'China',
      image: '/content/business/supplier-certificate.jpg',
      description: 'The world\'s factory floor. Building supplier relationships and sourcing premium products at the source.',
      highlights: 'Business & Sourcing',
    },
  ]
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] flex items-end justify-center px-4 pb-16 pt-24">
        <div className="absolute inset-0 z-0">
          <Image
            src="/content/travel/norway-winter.jpg"
            alt="Travel hero — Norway"
            fill
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            title="Destinations"
            subtitle="Places that inspire, connect, and transform"
            centered
          />
      ...
      <section className="py-20 px-4 bg-secondary/20">
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            ...
            subtitle="Moments captured across continents"
            centered
          />
      ...
      <section className="py-20 px-4 bg-background">
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            title="Travel Reels"
            subtitle="Stories in motion from the road"
            centered
          />
          <div className="mt-12">
