        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              With a deep passion for beauty, design, and meaningful connections, I&apos;ve dedicated my career to creating
              transformative experiences across multiple industries. After spending years in China — becoming fluent in Chinese,
              building supplier networks, and studying international business firsthand — I returned to Papua New Guinea with a vision.
            </p>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              From establishing Bilas Studio — a sanctuary for luxury beauty treatments where young women from settlements
              gain employment and professional skills — to curating Bilas Beauty&apos;s premium Pacific-inspired collection,
              each venture reflects my philosophy: that true beauty and business success emerge from thoughtful design,
              genuine relationships, and a commitment to quality that never wavers.
            </p>
            <p className="text-xl text-muted-foreground leading-relaxed">
              ConnetSuppliers represents the culmination of my understanding of global trade. With offices spanning
              Port Moresby, Guangzhou, and Tianjin, we bridge continents and cultures. Together, these ventures embody
              my vision: to inspire, elevate, and transform through luxury, innovation, and authentic connection.
            </p>
          </motion.div>
        </div>
      </section>
